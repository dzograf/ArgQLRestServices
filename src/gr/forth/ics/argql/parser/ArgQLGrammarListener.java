...
public interface ArgQLGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ArgQLGrammarParser#propositionPattern}.
	 * @param ctx the parse tree
	 */
	void enterPropositionPattern(ArgQLGrammarParser.PropositionPatternContext ctx);
	/**
	 * Exit a parse tree produced by {@link ArgQLGrammarParser#propositionPattern}.
	 * @param ctx the parse tree
	 */
	void exitPropositionPattern(ArgQLGrammarParser.PropositionPatternContext ctx);
	/**
