...
public class BackPattern extends RelationPattern {
	...
	public String getSparqlRepresentationNormal() {
		...
		str.append("{\n");
		str.append(concl1 +	" " + Names.iToS + " " + this.getAp2().getRaVariable() + "\n");
		str.append("} UNION {\n");
		equivPattern.setPropID(concl1);
		equivPattern.setEqPropID(eq);
		str.append(equivPattern.getSparqlRepresentation());
		str.append(eq +	" " + Names.iToS + " " + this.getAp2().getRaVariable() + "\n");
	...
	public String getSparqlRepresentationOptimized() {
		...
		//	str.append("}\n");
			...
			str.append(iNode1 + " " + Names.iToS + " " + this.getAp2().getRaVariable()+ ".\n");
			str.append(iNode1 + " " + Names.claimText + " " + txtVal + ".\n");
