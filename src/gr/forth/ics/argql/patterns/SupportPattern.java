...
*/
	...
	public String getSparqlRepresentationSimple() {
		...
		str.append("{ \n");
		str.append(back.getSparqlRepresentationSimple());
		str.append("} UNION {\n");
		str.append(endorse.getSparqlRepresentationSimple());
		str.append("}\n");
	...
	public String getSparqlRepresentation_simplest() {
		...
		str.append("{ \n");
		str.append(back.getSparqlRepresentation_simplest());
		str.append("} UNION {\n");
		str.append(endorse.getSparqlRepresentation_simplest());
		str.append("}\n");
